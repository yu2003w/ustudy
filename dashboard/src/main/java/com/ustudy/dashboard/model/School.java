...
public class School implements Serializable {
	...
	// Noted here: default constructor is required to make http.post to transfer
	// json
	...
	public School(long id, String schoolId, String schoolName, String schoolType, String province, String city,
			String district) {
		super();
		this.id = id;
