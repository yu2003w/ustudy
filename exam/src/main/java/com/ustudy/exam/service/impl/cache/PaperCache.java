...
public class PaperCache {
	 ...
	 * for final mark, need to populate more records
	 */
	private List<PaperImgCache> getPapersFromTeaCache(Map<String, MarkTaskCache> task, int seq, 
			int wanted, boolean isfinal, String quesid) {
