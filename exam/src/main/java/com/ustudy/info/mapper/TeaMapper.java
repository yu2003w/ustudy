...
public interface TeaMapper {
	...
	@Insert("insert into ustudy.teacherrole(role_id, teac_id) values (#{rid}, #{tid}) on duplicate key update")
	...
	public List<TeaGrade> getTeaGrade(String tid);
	...
	public List<Item> getTeaSubs(String tid);
